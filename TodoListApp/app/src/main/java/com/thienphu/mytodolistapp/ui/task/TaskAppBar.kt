...
fun BackAction(
    ...
    IconButton(onClick = {onBackClicked(Action.NO_ACTION)}) {
        Icon(imageVector = Icons.Filled.ArrowBack, contentDescription = "Back Arrow", tint = Color.White)
    }
}
...
fun ExistedTaskAppBar(
    ...
    TopAppBar(
        ...
        title = {
            Text(selectedTask.title, color = Color.White,
                fontStyle = FontStyle.Normal,
                fontWeight = FontWeight.SemiBold,
                fontFamily = FontFamily.SansSerif,
...
fun CloseAction(
    ...
    IconButton(onClick = {onCloseClicked(Action.NO_ACTION)}) {
        Icon(imageVector = Icons.Filled.Close, contentDescription = "Close Icon", tint = Color.White)
    }
}
...
fun UpdateAction(
    ...
    IconButton(onClick = {onUpdateClicked(Action.UPDATE)}) {
        Icon(imageVector = Icons.Filled.Check, contentDescription = "Update Icon", tint = Color.White)
    }
}
